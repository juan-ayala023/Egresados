      ...
      <div className="w-full max-w-md rounded-lg border border-white/10 bg-surface p-8 text-center shadow-2xl sm:p-10">
              ...
              {orden.boletas.map((b) => (
                <div key={b.id} className="rounded-sm border border-white/[0.1] bg-white/[0.02] p-6">
                  ...
                  <a
                    ...
                    className="mt-3 inline-flex items-center gap-2 font-body text-[11px] font-black uppercase tracking-[0.14em] text-muted transition-colors hover:text-gold"
                  >
            ...
            <div className="mt-8 space-y-2.5 text-left">
              {[
                ...
                <div key={k} className="flex justify-between gap-4">
                  <span className="font-body text-[11px] font-black uppercase tracking-[0.14em] text-muted">{k}</span>
        ...
        {fase === 'listo' && orden && orden.estado !== 'pagada' && (
          <>
            ...
            <p className="mt-5 font-body text-[11px] font-black uppercase tracking-[0.14em] text-muted">
              Orden {orden.referencia}
            </p>
          </>
        )}
        ...
        {fase === 'agotado' && (
          <>
            ...
            <p className="mt-5 font-body text-[11px] font-black uppercase tracking-[0.14em] text-gold">
              {referencia.current}
            </p>
        ...
        <a
          href="/"
          className="mt-9 inline-flex items-center gap-2 font-body text-[11px] font-black uppercase tracking-[0.14em] text-muted transition-colors hover:text-gold"
        >
