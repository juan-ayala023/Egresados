/* Glifo oficial de WhatsApp. lucide-react ya no trae iconos de marca, así que
   ...
   Vive en su propio archivo porque lo usan dos componentes: el flotante de
   soporte (BotonWhatsApp) y el de compartir con la promoción
   (CompartirWhatsApp). */
export default function IconoWhatsApp({ size = 26 }: { size?: number }) {
  return (
