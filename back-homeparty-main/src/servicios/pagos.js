...
export function aplicarPago(pago, origen = 'webhook') {
  const { referencia, estado, montoCentavos, metodoPago, franquicia, ultimosCuatro, autorizacionBanco, idTransaccion } = pago ?? {}
  ...
  try {
    resultado = confirmarPago(referencia, {
      ...
      autorizacionBanco: autorizacionBanco ?? null,
    })
  } catch (e) {
